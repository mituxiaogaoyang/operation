/**
 * @authors remy
 * @creatTime 2019-04-30 14:50:22
 * @description 萤石开发平台api
 * @version 0.1.0
 */
...
const vue = new Vue()
// const appKey = 'f28f073510fa4a03853527d37ebe6897';
// const appSecret = '1f6516eae6f7e545cc831064ffb18369'
// let accessToken = ''
// let expireTime = 0
...
function exceptionHandler (code, message) {
  // 20014 设备序列不正确
  // 10017 appKey不存在
  const isParamError = ['10017'].includes(code)
  message && vue.$message.error(isParamError ? '视频参数异常，无法开启视频监控' : message)
}
