...
(function (global, factory) {
  ...
  // 视频截图
  /* update by remy */
  EZUIPlayer.prototype.capturePicture = function (iWind, pictureName, fileFormat, callback) {
    if (!!this.jSPlugin) {
      return this.jSPlugin.JS_CapturePicture(iWind, pictureName, fileFormat, callback)
    } else {
      throw new Error("Method  not support");
    }
  }
